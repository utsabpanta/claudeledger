 ...
 *
 * PRIVACY: every path claudeledger reads is derived here, from a local directory
 * under the user's home (or an explicit override). Nothing in this file — or
 * anywhere in claudeledger — opens a network connection. This is the whole point of
